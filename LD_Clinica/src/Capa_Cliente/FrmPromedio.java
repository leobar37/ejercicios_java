 ...
 * @author JOSE
 */
public class FrmPromedio extends javax.swing.JDialog {

   
    public FrmPromedio(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
   ...
   private void Promedios(){
       ...
       int prome[]=Paciente.mostrarPacientesSexo();
       lblHombres.setText(""+prome[1]);
       lblMujeres.setText(""+prome[0]);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Promedio de Edades");
        ...
        lblHombres.setForeground(new java.awt.Color(0, 0, 0));
        lblHombres.setText("?????????");

        lblMujeres.setForeground(new java.awt.Color(0, 0, 0));
        lblMujeres.setText("?????????");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmPromedio dialog = new FrmPromedio(new javax.swing.JFrame(), true);
